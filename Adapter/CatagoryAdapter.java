...
public class CatagoryAdapter extends RecyclerView.Adapter<CatagoryAdapter.ViewHolder> {
    ArrayList <RecommendedDomain> RecommendedDomain;


    public CatagoryAdapter(ArrayList<RecommendedDomain> RecommendedDomain) {
   ...
   public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent,int viewType){
    ...
    holder.categoryName.setText(RecommendedDomain.get(position).getTitle());
    String picUrl ="";
    switch (position){
        case 0:{
            picUrl="cat_1";
